...
import image4 from '../assets/Urban1.png';
import image5 from '../assets/Urban2.png';
import image6 from '../assets/Urban3.png'
import image7 from '../assets/mrnaturalz1.png';
import image8 from '../assets/mrnaturalz2.png';
          ...
          <div className="-mx-4 flex flex-wrap items-center justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                Comprehensive Rebranding: Website, Graphics, and Social Media for Glossed Salon
                </h2>
                <p className="mb-5 text-base text-body-color dark:text-dark-6">We were thrilled to partner with Glossed Salon, a leading Hair Salon, to revitalize their brand identity. 
                </p>
              ...
              <li>
                ...
                <span>
                We crafted a fresh and contemporary brand identity that resonated with Glossed Salon's forward-thinking approach to salon marketing.
                </span>
              </li>
              <li>
                <span className="font-bold block">Website Development:</span>
                <span>
                We designed and developed a sleek and user-friendly website that showcased Glossed Salon's expertise and client portfolio.
                </span>
              </li>
              <li>
                ...
                <a href="https://glossedsalonstl.com/" target="_blank">
            <Button
              id="watch-trailer"
          ...
          <div className="-mx-4 flex flex-wrap items-center justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-5 text-base text-body-color dark:text-dark-6">We were delighted to partner with Urban Evolution Salon to elevate their online presence and connect them with more clients.
                </p>
                <p className="mb-4 text-base text-body-color dark:text-dark-6">
              ...
              <li>
                ...
                <span>
                We optimized Urban Evolution Salon' digital footprint to enhance their visibility and attract local customers.
                </span>
              </li>
              <li>
                <span className="font-bold block">Website Development:</span>
                <span>
                We designed and developed a user-friendly website that showcases their color expertise services, making it easy for clients to book appointments.
                </span>
              </li>
              <li>
              ...
              <li>
                ...
                <span>
                We created visually appealing and engaging social media content that highlights their color styles and promotes their services, helping build a strong online community.
                </span>
              </li>
             
            </ul>
                <a href="https://urbanevolutionsalon.com/" target="_blank">
            <Button
              id="watch-trailer"
              title="View Client's Website"
              leftIcon={<TiLocationArrow />}
          ...
          <div className="-mx-4 flex flex-wrap items-center justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <h2 className="mb-5 font-zentry text-3xl  text-dark dark:text-black sm:text-[40px]/[48px]">
                Comprehensive Rebranding: Website, Graphics, and Social Media for Mr. Naturalz Salon
                </h2>
                <p className="mb-5 text-base text-body-color dark:text-dark-6">We were thrilled to partner with Mr. Naturalz , a leading cannabis marketing agency, to revitalize their brand identity. 
                </p>
                <p className="mb-4 text-base text-body-color dark:text-dark-6">
                Our collaboration encompassed a comprehensive redesign, encompassing website development, graphic design, and social media content creation.
                </p>
              ...
              <li>
                ...
                <span>
                We crafted a fresh and contemporary brand identity that resonated with Mr. Naturalz's forward-thinking approach to cannabis marketing.
                </span>
              </li>
              <li>
                <span className="font-bold block">Website Development:</span>
                <span>
                We designed and developed a sleek and user-friendly website that showcased Mr. Naturalz Salon's expertise and client portfolio.
                </span>
              </li>
              <li>
                <span className="font-bold block">Social Media Content:</span>
                ...
                <a href="https://www.mrnaturalz.com/" target="_blank">
            <Button
              id="watch-trailer"
              title="View Client's Website"
              leftIcon={<TiLocationArrow />}
