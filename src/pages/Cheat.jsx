...
function MarketingCheatSheet() {
  return (
    <div>
          <title>Cheat Sheet Page | Texas Marketing | Marketing | Hue & Bloom Marketing</title>
    <meta
        name="description"
